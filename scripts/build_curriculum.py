...
A2 = [  # 1-9 sarf, 10-21 verb-forms, 22-27 weak-verbs, 28-35 grammar-ext, 36-47 saudi, 48-53 skills, 54 exam
    ...
    ("II bob: kuchaytirish (عَلَّمَ)", "فَعَّلَ — عَلَّمَ ni 14 shaklda tuslash", 8, "muallim · ta'lim ko'prigi", False),
    ("III bob: o'zaro harakat (سَاعَدَ)", "فَاعَلَ — سَاعَدَ ni 14 shaklda tuslash", 8, "musoada · mushohada", False),
    ("IV bob: sababiyat (أَرْسَلَ)", "أَفْعَلَ — أَرْسَلَ ni 14 shaklda tuslash", 8, "irsol · risola", False),
    ("V bob: II ning qaytimi (تَعَلَّمَ)", "تَفَعَّلَ — تَعَلَّمَ ni 14 shaklda tuslash", 8, "ta'lim · kalom", False),
    ("VI bob: o'zaro (تَعَاوَنَ)", "تَفَاعَلَ — تَعَاوَنَ ni 14 shaklda tuslash", 8, "taovun", False),
    ("VII bob: natija/qaytim (اِنْكَسَرَ)", "اِنْفَعَلَ — اِنْكَسَرَ ni 14 shaklda tuslash", 8, "inkisor", False),
    ("VIII bob: qaytim (اِجْتَمَعَ)", "اِفْتَعَلَ — اِجْتَمَعَ ni 14 shaklda tuslash", 8, "ijtimoiy · ehtirom", False),
    ("X bob: talab qilish (اِسْتَقْبَلَ)", "اِسْتَفْعَلَ — اِسْتَقْبَلَ ni 14 shaklda tuslash", 8, "istiqbol · istig'for", False),
